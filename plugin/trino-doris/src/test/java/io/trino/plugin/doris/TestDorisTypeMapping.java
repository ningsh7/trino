        ...
        extends AbstractTestQueryFramework
{
    ...
    private final TestingDorisEnvironment environment = new TestingDorisEnvironment(List.of(
            ...
            new TestingDorisEnvironment.TableDefinition(
                    ...
                    List.of(
                            row(
                                    "row_id", 1L,
                                    "bool_alias_col", 0L,
                                    "tiny_col", (long) Byte.MIN_VALUE,
                                    "small_col", (long) Short.MIN_VALUE,
                                    "int_col", (long) Integer.MIN_VALUE,
                                    "big_col", Long.MIN_VALUE,
                                    "unsigned_big_col", new BigDecimal("0"),
                                    "largeint_col", new BigInteger("-170141183460469231731687303715884105728")),
                            row(
                                    "row_id", 2L,
                                    "bool_alias_col", 1L,
                                    "tiny_col", (long) Byte.MAX_VALUE,
                                    "small_col", (long) Short.MAX_VALUE,
                                    "int_col", (long) Integer.MAX_VALUE,
                                    "big_col", Long.MAX_VALUE,
                                    "unsigned_big_col", new BigDecimal("18446744073709551615"),
                                    "largeint_col", new BigInteger("170141183460469231731687303715884105727")),
            ...
            new TestingDorisEnvironment.TableDefinition(
                    ...
                    List.of(
                            row(
                                    "row_id", 1L,
                                    "decimal_38_0_col", new BigDecimal("-99999999999999999999999999999999999999"),
                                    "decimal_38_18_col", new BigDecimal("-99999999999999999999.999999999999999999"),
                                    "oversized_decimal_col", new BigDecimal("-1234567890123456789012345678901234567890.123456")),
                            row(
                                    "row_id", 2L,
                                    "decimal_38_0_col", new BigDecimal("99999999999999999999999999999999999999"),
                                    "decimal_38_18_col", new BigDecimal("99999999999999999999.999999999999999999"),
            ...
            new TestingDorisEnvironment.TableDefinition(
                    ...
                    List.of(
                            ...
                            row(
                                    "row_id", 2L,
                                    "char_col", "xy  ",
                                    "varchar_col", "trailing spaces  ",
                                    "string_col", "中文 café 日本語"),
                            row(
                                    "row_id", 3L,
                                    "char_col", "abcd",
                                    "varchar_col", "hello doris",
                                    "string_col", "emoji 😀 and accents é"),
            ...
            new TestingDorisEnvironment.TableDefinition(
                    ...
                    List.of(
                            row(
                                    "row_id", 1L,
                                    "date_col", LocalDate.of(1582, 10, 4),
                                    "timestamp_col", LocalDateTime.of(2024, 3, 10, 1, 59, 59, 999_999_000)),
                            row(
                                    "row_id", 2L,
                                    "date_col", LocalDate.of(1582, 10, 15),
                                    "timestamp_col", LocalDateTime.of(2024, 3, 10, 3, 0, 0, 0)),
                            row(
                                    "row_id", 3L,
                                    "date_col", LocalDate.of(2024, 11, 3),
                                    "timestamp_col", LocalDateTime.of(2024, 11, 3, 1, 30, 0, 0)),
    ...
    private static Map<String, Object> nonNullRow()
    {
        return row(
                "bool_col", true,
                "bool_alias_col", false,
                "tiny_alias_col", 1L,
                "tiny_col", 7L,
                "small_col", 12L,
                "int_col", 34567L,
                "big_col", 9_876_543_210L,
                "unsigned_big_col", new BigDecimal("18446744073709551615"),
                "decimal_col", new BigDecimal("1234567890123456.78"),
                "largeint_col", new BigInteger("170141183460469231731687303715884105"),
                "char_col", "xy  ",
                "varchar_col", "hello doris",
                "string_col", "wide text",
                "date_col", LocalDate.of(2024, 3, 20),
                "timestamp_col", LocalDateTime.of(2024, 7, 25, 10, 2, 23, 586_123_000),
                "json_col", "{\"k\":1}",
                "oversized_decimal_col", new BigDecimal("1234567890123456789012345678901234567890.123456"));
    }
