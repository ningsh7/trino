...
final class TestDorisTypeMapper
{
    ...
    void testCharacterTemporalAndFallbackMappings()
    {
        ...
        assertThat(mapper.toTrinoType(column("name", "varchar", 32, null, 2))).isEqualTo(createVarcharType(32));
        assertThat(mapper.toTrinoType(column("created_on", "date_v2", null, null, 3))).isEqualTo(DATE);
        assertThat(mapper.toTrinoType(column("legacy_created_at", "datetime", null, 6, 4))).isEqualTo(createTimestampType(0));
        assertThat(mapper.toTrinoType(column("created_at", "datetime_v2", null, 6, 5))).isEqualTo(createTimestampType(6));
        assertThat(mapper.toTrinoType(column("payload", "json", null, null, 6))).isEqualTo(createUnboundedVarcharType());
    }
